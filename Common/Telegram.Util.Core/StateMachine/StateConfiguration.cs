...
namespace Telegram.Util.Core.StateMachine
{
    public partial class StateMachine<TState, TTrigger>
    {
        ...
        public partial class StateConfiguration
        {
            ...
            public async Task<StateConfiguration> InternalTransitionIf(TTrigger trigger, Func<object[], bool> guard, Func<Transition, Task> entryAction, string? guardDescription = null)
            {
                if (entryAction == null) throw new ArgumentNullException(nameof(entryAction));

                _representation.AddTriggerBehaviour(new InternalTriggerBehaviour.Sync(trigger, guard, async (t, args) => await entryAction(t), guardDescription));
                return this;
            }
            ...
            public StateConfiguration InternalTransition(TTrigger trigger, Func<Task> internalAction)
            {
                return InternalTransitionIf(trigger, t => true, internalAction);
            }
            ...
            public StateConfiguration InternalTransitionIf(TTrigger trigger, Func<object[], bool> guard, Func<Task> internalAction, string? guardDescription = null)
            {
                if (internalAction == null) throw new ArgumentNullException(nameof(internalAction));

                _representation.AddTriggerBehaviour(new InternalTriggerBehaviour.Sync(trigger, guard, async (t, args) => await internalAction(), guardDescription));
                return this;
            }
            ...
            /// <param name="guardDescription">Guard description</param>
            /// <returns>The receiver.</returns>
            public StateConfiguration PermitIf<TArg0>(TriggerWithParameters<TArg0> trigger, TState destinationState, Func<TArg0, bool> guard, string? guardDescription = null, Action? failFunc = null)
            {
                if (trigger == null) throw new ArgumentNullException(nameof(trigger));
                EnforceNotIdentityTransition(destinationState);
