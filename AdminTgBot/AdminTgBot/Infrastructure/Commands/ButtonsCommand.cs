...
{
	internal class ButtonsCommand : AdminBotCommandHandler
	{
		public ButtonsCommand(string command, CommandDisplay displayMode) : base(command, displayMode)
		{
		}
		...
		public override async Task StartCommandAsync(object stateManager, Message message)
		{
			...
			await (stateManager as AdminBotStateManager).ButtonsAsync(message);
		}
	}
}
