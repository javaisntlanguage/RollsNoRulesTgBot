...
{
    internal class CatalogEditorCommand : AdminBotCommandHandler
    {
        public CatalogEditorCommand(string command, CommandDisplay displayMode) : base(command, displayMode)
        {
        }
        ...
        public override async Task StartCommandAsync(object stateManager, Message message)
        {
            ...
            await (stateManager as StateManager).CatalogEditorAsync(message);
        }
    }
}
