...
{
    internal class StartCommand : AdminBotCommandHandler
    {
        public StartCommand(string command, CommandDisplay displayMode) : base(command, displayMode)
        {
        }
        ...
        public override async Task StartCommandAsync(object stateManager, Message message)
        {
            ...
            await (stateManager as AdminBotStateManager)!.StartAsync(message);
        }
    }
}
